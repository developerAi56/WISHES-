...
(hh = h / 2),
  (opts = {
    ...
    strings: ["HAPPY", "BIRTHDAY!", "KASHISH"],
    charSize: 30,
    charSpacing: 35,
    lineHeight: 40,
...
// Cake button popup functionality
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Show popup when cake button is clicked
  ...
  closePopup.addEventListener('click', function() {
    ...
    // Remove the 'flex' display after the animation completes
    setTimeout(() => {
